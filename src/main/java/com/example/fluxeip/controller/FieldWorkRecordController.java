...
public class FieldWorkRecordController {
    ...
    // 根據 ID 查詢外勤紀錄
    @GetMapping("/{id}")
    public Optional<FieldWorkRecord> getFieldWorkRecordById(@PathVariable Integer id) {
        return fieldWorkRecordService.getFieldWorkRecordById(id);
    }

    // 根據員工 ID 查詢外勤紀錄
    @GetMapping("/employee/{employeeId}")
    public List<FieldWorkRecord> getFieldWorkRecordsByEmployeeId(@PathVariable Integer employeeId) {
        return fieldWorkRecordService.getFieldWorkRecordsByEmployeeId(employeeId);
    }

    // 根據日期範圍查詢外勤紀錄
    @GetMapping("/date-range")
    public List<FieldWorkRecord> getFieldWorkRecordsByDateRange(
    ...
    public FieldWorkRecord updateFieldWorkRecord(@PathVariable Integer id, @RequestBody FieldWorkRecord updatedRecord) {
        return fieldWorkRecordService.updateFieldWorkRecord(id, updatedRecord);
    }
